...
/**
 * 第八个面积图
 * @param {Object} areaChart8Data 默认数据
 * @param {Array} color 颜色集合
 * @param {Array} xData 横坐标集合
 * @param {Array} sData 数据集合
 */
const areaChart8Data = {
  color: ["#269A99", "#0E80ED"],
  xData: ["2020-01", "2020-02", "2020-03", "2020-04", "2020-05"],
  yData: ["数量", "人均"],
  sData: [
    ...
    },
    {
      name: "Row",
      yAxisIndex: 1,
      data: [590, 180, 310, 290, 170],
    },
  ],
};
export const areaChart8 = ({
  color = areaChart8Data.color,
  xData = areaChart8Data.xData,
  yData = areaChart8Data.yData,
  sData = areaChart8Data.sData,
}) => {
